    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="exampleModalLongTitle">Form Tambah Detail Pembayaran Hutang Pelanggan, No.Peminjaman : <?= $nopeminjaman; ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open_multipart('peminjamanemas/simpandetailpembayaran') ?>
            ...
            <div class="modal-body">
                <p>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Jumlah Emas di-Bayarkan (Gram)</label>
                        <div class="col-sm-4">
