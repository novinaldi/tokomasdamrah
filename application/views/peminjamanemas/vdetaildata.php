        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-danger">
                    <?= anchor('peminjamanemas/data', '<i class="fa fa-backspace"></i> Kembali', array('class' => 'btn btn-outline-warning')) ?>
                    ...
                    <div class="col">
                        <table class="table table-striped">
                            <tr>
                                ...
                                <td>:</td>
                                <td align="right">
                                    <h4><?= number_format($jmltotalpinjam,2,",","."); ?></h4>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td align="right">
                                    <h4><?= number_format($jmltotalbayar,2,",","."); ?></h4>
                                </td>
                            </tr>
                            <tr>
                                <td>Status</td>
                        ...
                        <div class="col">
                            ...
                            <script>
                                function tambahpinjaman(nomor) {
                                    $.ajax({
                                        url: '<?= site_url('peminjamanemas/formtambahpinjaman') ?>',
                                        data: "&nomor=" + nomor,
                                        type: 'post',
                                        cache: false,
                        ...
                        <div class="col">
                            ...
                            <script>
                                function tambahpembayaran(nomor) {
                                    $.ajax({
                                        url: '<?= site_url('peminjamanemas/formtambahpembayaran') ?>',
                                        data: "&nomor=" + nomor,
                                        type: 'post',
                                        cache: false,
                                        success: function(data) {
    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <?php
                $querydatadetail = $this->db->query("SELECT iddetail,nodetail,tgl,IF(pilihan=1,jml,0) AS pinjam,IF(pilihan=2,jml,0) AS bayar,jml,buktifoto,ket FROM detailpinjaman_emas WHERE nodetail='$nopeminjaman' ORDER BY tgl,iddetail ASC");
                    ...
                    <tbody>
                        ...
                        foreach ($querydatadetail->result_array() as $d) {
                            ...
                            <tr>
                                ...
                                <td align="right"><?= number_format($d['pinjam'], 2,",",".") ?></td>
                                <td align="right"><?= number_format($d['bayar'], 2,",",".") ?></td>
...
<script>
    function hapusdetail(id, nopeminjaman) {
        Swal.fire({
            ...
            if (result.value) {
                location.href = ('<?= site_url('peminjamanemas/hapusdetaildata/') ?>' + id + '/' + nopeminjaman);
            }
        })
    }
    ...
    function tampilkanbukti(id) {
        $.ajax({
            url: '<?= site_url('peminjamanemas/tampilkanbuktifoto') ?>',
            data: "&id=" + id,
            type: 'post',
            cache: false,
            success: function(data) {
