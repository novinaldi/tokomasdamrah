        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <button type="button" class="btn btn-outline-success" onclick="window.location.href=('<?= site_url('peminjamanuang/data') ?>')">
                        <i class="fa fa-user-check"></i> Lihat Data</button>
                </h6>
            </div>
            <div class="card-body">
                <?= $this->session->flashdata('pesan'); ?>
                <?= form_open_multipart('peminjamanuang/simpandata') ?>
                    ...
                    <div class="col-sm-2">
                        ...
                        <script>
                            function caripelanggan() {
                                $.ajax({
                                    url: '<?= site_url('peminjamanuang/caripelanggan') ?>',
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Jumlah Pinjaman Awal (Rp)</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" required name="jmlpeminjaman">
                    </div>
                </div>
                <div class="form-group row">
