        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <button type="button" class="btn btn-outline-success" onclick="window.location.href=('<?= site_url('penitipanemas/data') ?>')">
                        <i class="fa fa-user-check"></i> Lihat Data</button>
                </h6>
            </div>
            <div class="card-body">
                <?= $this->session->flashdata('pesan'); ?>
                <?= form_open_multipart('penitipanemas/simpandata') ?>
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Tgl.Awal Penitipan</label>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-2">
                        ...
                        <script>
                            function caripelanggan() {
                                $.ajax({
                                    url: '<?= site_url('penitipanemas/caripelanggan') ?>',
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Pilih Jenis Emas</label>
                    <div class="col-sm-4">
                        <select class="form-control" name="jenisemas" required>
                            <option selected value="">-Pilih-</option>
                            <?php 
                            foreach($tampiljenisemas->result_array() as $j){
                                echo '<option value="'.$j['jenisid'].'">'.$j['jenisnama'].'</option>';
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Jumlah Penitipan Emas (Gram)</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" required name="jmlpenitipan">
                    </div>
                    <div class="col-sm-4">
