    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="exampleModalLongTitle">Form Tambah Detail Pengambilan , ID Penitipan : <?= $notitip; ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open_multipart('penitipan-uang/simpandetailpengambilan') ?>
            ...
            <div class="modal-body">
                <p>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Jumlah Uang di-ambil (Rp)</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Tambahkan Keterangan Pengambilan</label>
                        <div class="col-sm-9">
