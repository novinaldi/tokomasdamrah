...
<head>
    ...
    <title>Data Rekapitulasi Penitipan Uang || Toko Mas Damrah</title>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">
                            Rekapitulasi Penitipan Uang Pelanggan | Pilih Periode Tanggal Cetak
                        </h6>
                    </div>
                    <div class="card-body">
                        <?= form_open('report/tampillappenitipanuang', ['class' => 'formlaporan']) ?>
